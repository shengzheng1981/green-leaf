...
export const opera = !!(window as any).opera;
...
export const any3d = !(window as any).L_DISABLE_3D && (ie3d || webkit3d || gecko3d) && !opera12 && !phantom;
...
export const msPointer = !window.PointerEvent && (window as any).MSPointerEvent;
...
export const touch = !(window as any).L_NO_TOUCH;
