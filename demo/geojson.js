...
window.load = async () => {
  ...
  const geojsonAdapter = new GeoJSONAdapter(GeometryType.Polygon, "https://raw.githubusercontent.com/shengzheng1981/green-leaf/master/demo/assets/geojson/beijing.json");
